...
is_termlog( {
        "0,0" => [ SETPEN,
                   ...
                   SETBG(undef),
                   ERASECH(66) ],
        ( map { +"$_,0" => [ SETBG(undef), ERASECH(74) ] } 1 .. 24 ),

        "0,74" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("< "),
                    SETPEN(fg => 14,bg => 4),
                    PRINT("tab0") ],
        "1,74" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("  "),
                    SETPEN(fg => 7,bg => 4),
                    PRINT("tab1") ],
        "2,74" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("  "),
                    SETPEN(fg => 7,bg => 4),
                    PRINT("tab2") ],
        ( map { +"$_,74" => [ SETBG(4), ERASECH(6) ] } 3 .. 24 ),
        }, 'Termlog initially' );
...
is_termlog( {
        "0,72" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("    "),
                    SETPEN(fg => 7,bg => 4),
                    PRINT("tab0") ],
        "1,72" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("<<< "),
                    SETPEN(fg => 14,bg => 4),
                    PRINT("tab1") ],
        "2,72" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("    "),
                    SETPEN(fg => 7,bg => 4),
                    PRINT("tab2") ],
        "3,72" => [ SETPEN(fg => 7,bg => 4),
                    PRINT("  "),
                    SETPEN(fg => 7,bg => 4),
                    PRINT("newtab") ],
        ( map { +"$_,72" => [ SETBG(4), ERASECH(8) ] } 4 .. 24 ),

        "0,0" => [ SETPEN,
                   PRINT("Widget 1"),
                   SETBG(undef),
                   ERASECH(64) ],
        ( map { +"$_,0" => [ SETBG(undef), ERASECH(72) ] } 1 .. 24 ),
